...
class Draw:
    ...
    def generate_final_surface_MP4(  self,
        ...
        with open(filename,'w') as file_obj:
            json.dump(  {'iden_model':iden_model_path,
...
if __name__ == '__main__':
    ...
    draw.generate_final_surface_MP4(
                                    iden_model_path='/usr/commondata/weather/code/Precipitation_Estimation/Precipitation/results/identification/007/epoch_13_step_13.pt',
                                    #'/usr/commondata/weather/code/Precipitation_Estimation/Precipitation/results/identification/007/epoch_6_step_6.pt',
                                    esti_model_path='/usr/commondata/weather/code/Precipitation_Estimation/Precipitation/results/estimation/changew3/007/epoch_15.pt',
                                    train_path='/usr/commondata/weather/dataset_release/IR_dataset_QingHua/',
                                    step=14,
                                    data_X='X_val_hourly.npz',
                                    data_Y='Y_val_hourly.npz',
                                    save_path='/usr/commondata/weather/code/Precipitation_Estimation/Precipitation/Visualization/esti_val3',
                                    save_name='val',
                                    specify_task='estimation')
