...
parser.add_argument('--model', type=str, default='baseline', help='model type: baseline|mask|consistency|contrastive')
parser.add_argument('--coeff', type=float, default=1.0, help='coeff of aux loss')
parser.add_argument('--weight', type=bool, default=True, help='loss with weight')

################################
# data settings
################################
parser.add_argument('--dataset', type=str, default='goes', help='chooses which dataset is loaded. [cityscapesAB | horse | m2nist | modis | goes]')
